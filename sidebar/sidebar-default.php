...
<div id="sidebar">
	<div id="primary-sidebar">
		<div class="widget main-title">
			<h1><a href="<?php bloginfo('url') ?>/" title="Home" rel="home"><img src="<?php bloginfo('template_directory'); ?>/img/sopr-logo.png" alt="<?php bloginfo('name') ?>" title="<?php bloginfo('name') ?>"></a></h1>
		</div>
<?php
$post = $orig_post;
